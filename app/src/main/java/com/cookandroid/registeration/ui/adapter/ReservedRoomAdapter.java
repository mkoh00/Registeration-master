...
public class ReservedRoomAdapter extends RecyclerView.Adapter<ReservedRoomAdapter.EmptyRoomViewHolder> {
    ...
    public EmptyRoomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_reserved_room, parent, false);
